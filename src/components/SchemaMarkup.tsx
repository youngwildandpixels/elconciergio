    ...
    offers: [
      {
        ...
        description: 'Gîtes & Airbnb : un logement unique, 2 mois offerts',
        price: '500',
        priceCurrency: 'EUR',
        priceSpecification: {
      ...
      },
      {
        '@type': 'Offer',
        name: 'Pro (annuel)',
        description: "Chambres d'hôtes & B&B : plusieurs chambres, 2 mois offerts",
        price: '1500',
        priceCurrency: 'EUR',
        priceSpecification: {
          '@type': 'UnitPriceSpecification',
      ...
      },
      {
        '@type': 'Offer',
        name: 'Premium (annuel)',
        description: 'Petits hôtels & Résidences : établissements pro, 2 mois offerts',
        price: '3500',
        priceCurrency: 'EUR',
        priceSpecification: {
          '@type': 'UnitPriceSpecification',
